...
window.IPCHFEmail = 'dianorashop@gmail.com';

var intepriceIPL = 'dianora.inteprice.com';
var intepriceCRT = '27.04.2021';
...
//	"workDays": "Mon, Tue, Wed, Thu, Fri, Sat, Sun",
		...
		"AdwConvRemark": {
		google_conversion_id: 382882479,
...
//https://dianora.ua/success

		"HitElement": "h1",
		"HitElementHtml": {RegExp: 'Замовлення успішно сформоване!', Flags: 'i'},
...
//for one
		google_conversion_label: "pNgcCODmkIwCEK-lybYB",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "AynXCM7gkIwCEK-lybYB",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "ZWqRCIvlkIwCEK-lybYB",
		google_remarketing_only: false
			},
...
//		"ExtFormBtnFC": '[type=submit], input[type=image], input[type=button], button:not([type=reset])',
		"ExtFormBtnFC": '.col-sm-8 > button[type=submit]',
		"ButtonSensitivity":	"0",
		"ButtonTransform": 3,
