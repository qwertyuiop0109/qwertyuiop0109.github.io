...
var intepriceIPL = 'akonit.inteprice.com';
var intepriceCRT = '11.05.2021';
...
//    "font_type": "normal",
	...
	"workStart": "09",
	"workEnd": "21",
	"workDays": "Mon, Tue, Wed, Thu, Fri, Sat:10:18, Sun:10:18",




		"AdwConvRemark": {
		google_conversion_id: 370072372,
...
//https://akonit.net/success/
//Ваш заказ №3649 принят!
//Заказ успешно сформирован!


		"HitElement": "a.current-link",
		"HitElementHtml": {RegExp: 'Успешно', Flags: 'i'},
		...
		google_conversion_label: "xP34CJXIrJICELS2u7AB",
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "m3atCOWnppICELS2u7AB",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "jSnmCNXGrJICELS2u7AB",
		google_remarketing_only: false
			},
...
//		"titlenight": "Мы перезвоним в рабочее время",
		...
		"ExtFormFCOnly": {RegExp: '>(Заказать|Отправить)<', Flags: 'i'},
		"ExtFormBtnFC": '#popup-checkout-button, #popup-send-button',
		"ButtonSensitivity":	"0",
		"ButtonTransform": 3,
