...
var intepriceIPL = 'dobroznak.inteprice.com';
var intepriceCRT = '13.01.2023';
...
//    "font_type": "normal",
	...
	"lblOfflineMessageSend": "Повідомлення відправлено",
        ...
        "lblLookingForFreeAgent": "Підключаємося...",
        "lblIntroduceName": "Ваше ім'я",
        "lblEvaluateCancel": "Скасувати",
        "lblSend": "Надіслати",
        "lblThankYouMessage": "Дякуємо за ваше повідомлення! Ми&nbsp;обов'язково зв'яжемося з&nbsp;Вами найближчим часом",
...
/*
		...
		"AdwConvRemark": {
		google_conversion_id: 543332288,
...
*/
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "xXCLCM-H1ooYEMCvioMC",
		google_remarketing_only: false
			},
		...
		google_conversion_format: "3",
		google_conversion_color: "ffffff",
		google_conversion_label: "owtBCLCS1ooYEMCvioMC",
		google_remarketing_only: false
			},
...
//		"ButtonMobileCSS": "background:url(data:image/png;base64,) center center no-repeat!important; position:fixed!important;bottom:0;right:0!important;height:128px!important;width:59px!important;cursor:pointer",
	...
	"consultantSettings": {
		...
		Simulation: 1,
	        ...
	        prepare_message: 'Ваш запит підготовлен для відправки консультанту!<br><br>Для підвищення якості нашого обслуговування, просимо вас представитися:',
	        prepare_forced: 1,
	        title: 'Є питання? Задайте зараз',
	        title_off_forced: 1,
	        title_on_forced: 1,
		answer: "Дякуємо!</br>Ваш запит вже передано консультанту,</br>але його лінія зараз зайнята.</br></br>Консультант зв'яжеться з Вами трохи пізніше.",
		timeout: 15,
	        days: 14,
	        mobile: 0,
	        worktime: 0,
//	        message: "Вітаю! Напишіть нам що саме вас цікавить і ми оперативно надамо вам інформацію.",
	        message: "Вітаю! Напишіть що саме вас цікавить і я оперативно надам вам інформацію.",
	        invite_off_forced: 1,
	        invite_on_forced: 1,
	        submit: "Отримати відповідь",
	        submit_forced: 1,
	        name: 'Консультант',
	        name_forced: 0,
