...
*/
		...
		"title": "Obțineți o consultație",
		"titlenight": "Vă vom contacta în timpul programului de lucru",
		"titleworktime": "Vă vom contacta în câteva minute",
		"button": "Aștept răspunsul!",
		"fields": "+Introduceți numărul dvs. de telefon(+40)*, Introduceți adresa dvs. de email(opțional), -Subiect(Întrebarea dvs.)*",
		"callTime": "0",
		"emptyPhone": "+40",
...
//		"ExtFormFCOnly": {RegExp: '<[^>]+("[ ]*Plasează[ ]+comanda[ ]*"|\'[ ]*Plasează[ ]+comanda[ ]*\')', Flags: 'i'},
...
//		"ButtonMobileCSS": "background:url(data:image/png;base64,) center center no-repeat!important; position:fixed!important;bottom:0;right:0!important;height:128px!important;width:59px!important;cursor:pointer",
	...
	"consultantSettings": {
		...
		prepare_message: 'Cererea dvs. este pregătită pentru trimitere către consultant!<br><br>Pentru îmbunătățirea calității serviciilor noastre, vă rugăm să vă prezentați:',
		prepare_forced: 1,
		title: 'Puneți o întrebare acum',
		title_off_forced: 1,
		title_on_forced: 1,
		answer: 'Mulțumim!</br>Cererea dvs. a fost deja trimisă consultanțului,</br>dar linia sa este ocupată în acest moment.</br></br>Consultantul se va conecta cu dumneavoastră mai târziu.',
		timeout: 15,
		days: 14,
		mobile: 0,
		worktime: 0,
		message: "Bună ziua! Dacă aveți întrebări, voi fi bucuros să răspund la ele.",
		invite_off_forced: 1,
		invite_on_forced: 1,
		submit: "Obțineți o consultație",
		submit_forced: 1,
		name: 'Consultant',
		name_forced: 0,
		...
		"consultantSendContacts": "Datele dvs. de contact",
